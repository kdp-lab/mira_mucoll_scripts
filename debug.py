...
reco_dir = Path("/scratch/miralittmann/analysis/mira_analysis_code/efficiency/nobib/medium/4000_10/hit_level/")
prefix = "4000_10_reco"
reco_files = []
num_plots = 40
...
med_time = {"VB":0.32, "IB":1.25, "OB":4}
tight_time = {"VB":0.15, "IB": 0.3, "OB":0.3}
    ...
    for reco_file in reco_files:
        ...
        for det in ("VB", "IB", "OB"):
            ...
            for i in range(len(time)):
                print(time[i], med_time[det])
                if time[i] < med_time[det]:
                    in_time.append(True)
                else:
        ...
        ax.scatter(r_all[~in_time_all], z_all[~in_time_all], label="out of window", marker='x', color="red", s=40)  
