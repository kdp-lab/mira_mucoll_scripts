...
CACHE = pathlib.Path("cache/sig_with_track_level_pt2.pkl") #-nozero

plot_path = "/scratch/miralittmann/analysis/mira_analysis_code/lifetimes-decaypos-full.pdf"
track_stats_plot_path = "/scratch/miralittmann/analysis/mira_analysis_code/sig_with_track_level_pt2.pdf" # -nozero
...
plot_leading_subleading_eventnorm(
    ...
    out_pdf="/scratch/miralittmann/analysis/mira_analysis_code/stau_lead_sublead_pt2.pdf",
)
